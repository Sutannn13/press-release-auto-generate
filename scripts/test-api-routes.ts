...
async function main() {
  ...
  const [{ POST: generate }, { POST: exportDocx }, { GET: health }] = await Promise.all([
  ...
  console.log("API health, akses langsung, origin, 422, rate-limit, foto wajib export, dan DOCX lulus.");
}
